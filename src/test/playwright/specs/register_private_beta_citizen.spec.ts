...
import { BuildInfoHelper } from '../../v2/common/build_info';
import { clickAndExpectHeading, loginAs } from '../helpers/ui-auth';

test.describe('v2_register_private_beta (Playwright migration)', () => {
  test.skip(!process.env.FUNCTIONAL_TEST_SERVICE_CLIENT_SECRET, 'FUNCTIONAL_TEST_SERVICE_CLIENT_SECRET is required');
