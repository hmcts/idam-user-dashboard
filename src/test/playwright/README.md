...
- `yarn test:functional` runs the migrated functional + accessibility suite in Playwright.
- `yarn test:functional:pw:list` lists functional tests using the Jenkins-compatible Playwright config.
- `yarn test:crossbrowser:pw:list` lists the Playwright cross-browser test matrix.
- `yarn test:crossbrowser` runs Playwright tests across Chromium, Firefox, and WebKit.
